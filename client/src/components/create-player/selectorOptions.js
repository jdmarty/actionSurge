...
export const subraceOptions = {
  ...
  goliath: [{ value: "", label: "None" }],
  aasimar: [
    { value: "protector-aasimar", label: "Protector Aasimar" },
    { value: "scourge-aasimar", label: "Scourge Aasimar" },
    { value: "fallen-aasimar", label: "Fallen Aasimar" },
  ],
  bugbear: [{ value: "", label: "None" }],
  firbolg: [{ value: "", label: "None" }],
  goblin: [{ value: "", label: "None" }],
  hobgoblin: [{ value: "", label: "None" }],
  kenku: [{ value: "", label: "None" }],
  kobold: [{ value: "", label: "None" }],
  lizardfolk: [{ value: "", label: "None" }],
  orc: [{ value: "", label: "None" }],
  tabaxi: [{ value: "", label: "None" }],
  triton: [{ value: "", label: "None" }],
  "yuan-ti": [{ value: "", label: "None" }],
  changeling: [{ value: "", label: "None" }],
  kalashtar: [{ value: "", label: "None" }],
  shifter: [{ value: "", label: "None" }],
  warforged: [{ value: "", label: "None" }],
  gith: [
...
export const subclassOptions = {
  barbarian: [
    ...
    { value: "totem-warrior", label: "Totem Warrior" },
    { value: "ancestral-guardian", label: "Ancestral Guardian" },
    { value: "battlerager", label: "Battlerager" },
    { value: "storm-herald", label: "Storm Herald" },
    { value: "zealot", label: "Zealot" },
    { value: "", label: "None" },
  ],
  bard: [
    { value: "lore", label: "College of Lore" },
    { value: "swords", label: "College of Swords" },
    { value: "glamour", label: "College of Glamour" },
    { value: "valor", label: "College of Valor" },
    { value: "whispers", label: "College of Whispers" },
    { value: "", label: "None" },
  ],
  cleric: [
  ...
  druid: [
    ...
    { value: "moon", label: "Circle of Moon" },
    { value: "dreams", label: "Circle of Dreams" },
    { value: "shepard", label: "Circle of the Shepard" },
    { value: "", label: "None" },
  ],
  fighter: [
    ...
    { value: "arcane-archer", label: "Arcane Archer" },
    { value: "cavalier", label: "Cavalier" },
    { value: "echo-knight", label: "Echo Knight" },
  ...
  monk: [
    ...
    { value: "four-elements", label: "Way of Four Elements" },
    { value: "drunken-master", label: "Way of Drunken Master" },
    { value: "kensei", label: "Way of the Kensei" },
    { value: "long-death", label: "Way of the Long Death" },
    { value: "sun-soul", label: "Way of the Sun Soul" },
    { value: "", label: "None" },
  ],
  paladin: [
    { value: "devotion", label: "Oath of Devotion" },
    { value: "ancients", label: "Oath of Ancients" },
    { value: "vengeance", label: "Oath of Vengeance" },
    { value: "conquest", label: "Oath of Conquest" },
    { value: "redemption", label: "Oath of Redemption" },
    { value: "crown", label: "Oath of the Crown" },
  ...
  ranger: [
    ...
    { value: "gloom-stalker", label: "Gloom Stalker" },
    { value: "horizon-walker", label: "Horizon Walker" },
    { value: "monster-slayer", label: "Monster Slayer" },
    { value: "", label: "None" },
  ],
  rogue: [
  ...
  sorcerer: [
    ...
    { value: "storm", label: "Storm Sorcery" },
    { value: "", label: "None" },
  ],
  warlock: [
    { value: "fiend", label: "The Fiend" },
    { value: "archfey", label: "The Archfey" },
    { value: "great-old-one", label: "The Great Old One" },
    { value: "celestial", label: "The Celestial" },
    { value: "hexblade", label: "The Hexblade" },
    { value: "undying", label: "The Undying" },
    { value: "", label: "None" },
  ],
  wizard: [
